...
export function Footer() {
  return (
    <footer className="relative z-10 w-full border-t border-white/5 bg-black/30 backdrop-blur-xl h-12 flex items-center">
        ...
        <div className="flex items-center gap-6">
          {[
            ...
            <Link
              key={link.href}
              href={link.href}
              className="text-[11px] font-medium text-[#8888aa] hover:text-white transition-colors duration-300 uppercase tracking-wider"
            >
              {link.label}
            </Link>
          ))}
